...
- Name: constructor.pl.tsx >> Burger constructor >> Создание заказа: верный номер и очистка конструктора + закрытие модалки
- Location: src\tests\constructor.pl.tsx:140:7
